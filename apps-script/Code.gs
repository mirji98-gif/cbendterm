 ...
 *  144 columns · 52 assignment slots · sequence seed 20260910
 * ═══════════════════════════════════════════════════════════════════════════
 *
...
var COLUMNS = [
  ...
  'neutral_p1_position',
  'neutral_p1_choice',
  'neutral_p1_response_code',
  'neutral_p1_latency_ms',
  'neutral_p1_time_to_first_touch_ms',
  'neutral_p1_cancelled_taps',
  'neutral_p1_pointer_cancels',
  'neutral_p1_press_dwell_ms',
  'neutral_p1_post_dismiss_dwell_ms',
  'neutral_p1_continuation_auto_advanced',
  'neutral_p1_scroll_events',
  'neutral_p1_rage_taps',
  'neutral_p1_popup_render_gap_ms',
  'neutral_p1_abandoned',
  'neutral_p2_brand',
  'neutral_p2_ask',
  'neutral_p2_position',
  'neutral_p2_choice',
  'neutral_p2_response_code',
  'neutral_p2_latency_ms',
  'neutral_p2_time_to_first_touch_ms',
  'neutral_p2_cancelled_taps',
  'neutral_p2_pointer_cancels',
  'neutral_p2_press_dwell_ms',
  'neutral_p2_post_dismiss_dwell_ms',
  'neutral_p2_continuation_auto_advanced',
  'neutral_p2_scroll_events',
  'neutral_p2_rage_taps',
  'neutral_p2_popup_render_gap_ms',
  'neutral_p2_abandoned',
  'exp_condition',
  'exp_brand',
  'exp_block_position',
  'exp_decline_label',
  ...
  'exp_p1_position',
  'exp_p1_choice',
  'exp_p1_response_code',
  'exp_p1_latency_ms',
  'exp_p1_time_to_first_touch_ms',
  'exp_p1_cancelled_taps',
  'exp_p1_pointer_cancels',
  'exp_p1_press_dwell_ms',
  'exp_p1_post_dismiss_dwell_ms',
  'exp_p1_continuation_auto_advanced',
  'exp_p1_scroll_events',
  'exp_p1_rage_taps',
  'exp_p1_popup_render_gap_ms',
  'exp_p1_abandoned',
  'exp_p2_brand',
  'exp_p2_ask',
  'exp_p2_position',
  'exp_p2_choice',
  'exp_p2_response_code',
  'exp_p2_latency_ms',
  'exp_p2_time_to_first_touch_ms',
  'exp_p2_cancelled_taps',
  'exp_p2_pointer_cancels',
  'exp_p2_press_dwell_ms',
  'exp_p2_post_dismiss_dwell_ms',
  'exp_p2_continuation_auto_advanced',
  'exp_p2_scroll_events',
  'exp_p2_rage_taps',
  'exp_p2_popup_render_gap_ms',
  'exp_p2_abandoned',
  'neutral_b1_guilt',
